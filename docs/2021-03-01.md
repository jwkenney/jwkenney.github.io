...
<div style="text-align: left;">Either build a new host from scratch exactly the way you expect it to be, or identify a host which you think is the closest to a "reference" build. This will be the host that you compare the others against.  
</div>
