...
This is part of a (maybe ongoing) series of dirty tips and tricks with Ansible. Is this stuff sanctioned, best-practice or _<gasp>_ an anti-pattern? Considering how gnarly Ansible's trifecta of Jinja/YAML/Python can be, I'm going to answer _[Mu](https://en.wikipedia.org/wiki/Mu_%28negative%29#%22Unasking%22_the_question)_ to that question. In the meantime, we have deliverables to make!
